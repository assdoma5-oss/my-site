...
const text = `كل سنة وانتي طيبة يا أجمل حاجة في حياتيكل سنة وانتي طيبة يا أجمل حاجة في حياتي ❤️
...
if (bubblesCanvas) {
    ...
    function drawBubbles() {
        ...
        bubblesCtx.clearRect(
            0,
            0,
            bubblesCanvas.width,
            bubblesCanvas.height
        );
